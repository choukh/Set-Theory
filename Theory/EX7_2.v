...
Proof with auto.
  ...
  - apply SepI. apply binRelE3 in Hlt.
    ...
    apply CPrdI; apply ω_embed_ran_nn...
...
Proof with neauto; try congruence; try tauto.
  ...
  - apply e_elim in Hx...
    ...
    + apply BUnionI1.
      ...
      rewrite add_0_r, add_0_r, (embed_proj_id m)...
    + apply SingE in H. rewrite H, ω_embed, IHn...
  - assert (Hnsn: Int n <𝐳 Int (S n)). {
      apply intLtI... rewrite add_0_r, add_0_r...
  ...
  - eapply (e_intro _ _ (Int x))...
    + apply binRelI...
      ...
      * exfalso. apply intLt in Hnx...
        rewrite add_0_r, add_0_r in Hnx... exfalso0.
      * exfalso. assert (intNeg (-Int 1)) by nauto...
...
Proof with nauto.
  unfold Int. rewrite intAddInv, intAddInv, 
    intAdd_m_n_p_q, add_0_r, add_0_l...
  apply int_ident... rewrite add_0_l, add_1_1...
Qed.
...
Proof with neauto; try congruence.
  ...
  - apply BUnionE in Hx as [Hx|Hx].
    ...
    + apply SingE in Hx. subst x.
      ...
      destruct (ixm (intNeg (-Int 2))) as [Hnn2|Hnnn2]...
      * unfold Int. rewrite intAddInv, intAddInv...
        apply intLt... rewrite add_0_l, add_0_l...
        apply suc_has_n.
      * assert (intNeg (- Int 2))...
Qed.
