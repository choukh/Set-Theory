...
Require Import ZFC.Theory.EX7_1.
Require Import ZFC.Theory.EX8_2.
...
Proof with eauto.
  ...
  eapply relLt_le_trans... apply lo.
Qed.
...
Proof with eauto; try congruence.
  ...
  pose proof (HdnS (f[aₗ]) (f[aᵣ])) as [qₘ [H1 H2]]. {
    ...
    eapply Hop... eapply relLt_trans... apply HloR.
  }
  assert (Hqₘ: qₘ ∈ B). {
    apply HloS in H1. apply CPrdE2 in H1 as [_ H]...
  }
...
Proof with eauto; try congruence.
  ...
  - assert (HNᵣ: (Min Lt)[Nᵣ] ∈ Nᵣ). eapply (right_nats A R a)...
    ...
    * apply Hle in H... eapply (relLt_irrefl _ R)...
      eapply relLt_le_trans; revgoals... eapply Hop...
    ...
    unfold Add; [
      ...
      - split; intros Hlt.
        ...
        + set (RightNats x₀ R S b f) as N.
          ...
          eapply relLt_le_trans... apply Hop... eapply relLt_trans...
      - split; intros Hlt.
      ...
      - split; intros Hlt.
        ...
        + set (LeftNats x₀ R S b f) as N.
          ...
          apply (lo_connected R A) in Hnq as [H20|H02]; revgoals...
          exfalso. eapply (relLt_irrefl x₂ R)...
          eapply relLe_lt_trans... apply Hop... eapply relLt_trans...
      - split; intros Hlt.
        + set (MidNats x₀ R S b f) as N.
          assert ((Min Lt)[N] ∈ N). eapply (mid_nats A)...
          apply SepE2 in H as [_ H].
...
Proof with neauto; try congruence.
  ...
  assert (Hg: g: ps ⇒ ps). {
    ...
    apply CPrdE1 in Hp as [n [Hn [f [Hf Hp]]]].
    ...
    - destruct (ixm (odd n)). {
      ...
      + zfc_simple. simpl. destruct (ixm (odd n⁺))... split.
        * rewrite odd_halve_suc, even_halve_suc...
        * rewrite even_halve_suc... eapply sub_trans...
  ...
  assert (HG: G: ω ⇒ fs). {
    ...
    apply CPrdE1 in Hhn as [k [_ [f [Hf Heq]]]].
  ...
  assert (HsubGn: ∀n ∈ ω, a⟦½n⟧ ⊆ dom G[n] ∧ b⟦½n⟧ ⊆ ran G[n]). {
    ...
    apply CPrdE1 in Hp as [k [_ [f [_ Heq]]]].
    ...
    - destruct (ixm (odd n)); destruct H as [H1 H2].
      + split... rewrite odd_halve_suc in H1...
        eapply sub_trans; revgoals... apply ex3_22_a...
      + split...
  ...
  assert (Hsubd0: ∀n ∈ ω, dom G[n] ⊆ dom G[n⁺]). {
    ...
    apply CPrdE1 in Hp as [k [Hk [f [_ Heq]]]].
  ...
  assert (Hsubd: ∀n ∈ ω, ∀m ∈ n, dom G[m] ⊆ dom G[n]). {
    ...
    apply BUnionE in Hk as [].
    - eapply sub_trans. apply IH... apply Hsubd0...
  ...
  assert (Hsubr: ∀n ∈ ω, ∀m ∈ n, ran G[m] ⊆ ran G[n]). {
    ...
    ω_induction n; intros k Hk. exfalso0.
    apply BUnionE in Hk as [].
    - eapply sub_trans. apply IH... apply Hsubr0...
  ...
  assert (Hin0: ∀n ∈ ω, ∀x ∈ dom G[n], G[n][x] = G[n⁺][x]). {
    ...
    assert (Hnp: n⁺ ∈ ω). apply ω_inductive...
    apply Hhnps in Hn as Hhn. apply SepE1 in Hhn.
    apply CPrdE1 in Hhn as [k [Hk [f [Hf Heq]]]].
  ...
  assert (Hout0: ∀n ∈ ω, ∀x ∈ dom G[n⁺] - dom G[n], G[n⁺][x] ∉ ran G[n]). {
    ...
    assert (Hnp: n⁺ ∈ ω). apply ω_inductive...
    apply Hhnps in Hn as Hhn. apply SepE1 in Hhn.
    apply CPrdE1 in Hhn as [k [Hk [f [Hf Hhn]]]].
