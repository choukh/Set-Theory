...
Proof with eauto.
  ...
  - (* single-valued *)
    ...
    apply CPrdE1 in Ha1 as [a [Ha [b [Hb Ha1]]]].
    apply CPrdE1 in Ha2 as [c [Hc [d [Hd Ha2]]]].
    subst. zfc_simple.
    eapply eqvc_ident in H1...
    eapply eqvc_ident in H2...
    assert (<F[<a, b>], F[<c, d>]> ∈ R) by (apply Hcom; eauto).
    assert (Hd1: <a, b> ∈ A × A) by (apply CPrdI; eauto).
    assert (Hd2: <c, d> ∈ A × A) by (apply CPrdI; eauto).
  ...
  - (* dom F' = (A/R) × (A/R) *)
    ...
    + apply domE in Hx as [y Hp]. apply ReplAx in Hp as [a [Hp Heq]].
      ...
      apply CPrdE1 in Hp as [c [Hc [d [Hd Ha]]]].
      subst. zfc_simple. apply CPrdI; apply quotI...
...
Proof with eauto.
  ...
  apply op_iff. split... apply cprd_is_pairs in Hd.
...
Proof with eauto.
  ...
  assert (Hd: <[x]R, [y]R> ∈ (A/R) × (A/R)) by (apply CPrdI; auto).
  ...
  - apply Hrf. eapply ranI... apply func_correct...
    rewrite Hdf. apply CPrdE0 in Hb as []. apply CPrdI...
  - apply Hrf. eapply ranI... apply func_correct...
    rewrite Hdf. apply CPrdE0 in Hb as []. apply CPrdI...
  - apply op_iff in H1 as [H11 H12].
    apply CPrdE0 in Hb as [Hb1 Hb2].
...
Proof with auto.
  intros A B x Hx.
  apply CPrdE1 in Hx as [u [Hu [v [Hv Hx]]]].
  apply CPrdE1 in Hu as [m [Hm [n [Hn Hu]]]].
  apply CPrdE1 in Hv as [p [Hp [q [Hq Hv]]]].
...
Proof with auto.
  ...
  apply SepI. apply CPrdI; apply CPrdI... zfc_simple...
Qed.
...
Proof with eauto.
  ...
  - intros x y Hqv. apply planeEquivE1 in Hqv
    ...
    subst. apply SepI. apply CPrdI; apply CPrdI...
...
Proof with eauto.
  ...
  - eapply eqvc_ident; swap 1 3. apply planeEquiv_equiv...
    apply CPrdI... apply CPrdI... apply planeEquivI...
  - cut ((<m, n> ~ <p, q>) A B Eq). intros H.
    apply planeEquiv in H...
    eapply eqvc_ident; revgoals. apply Heq.
    apply planeEquiv_equiv... apply CPrdI... apply CPrdI...
Qed.
...
Proof with eauto.
  ...
  - (* is_rel *) intros x Hx.
    apply SepE in Hx as [Hx _]. apply cprd_is_pairs in Hx...
  - (* single-valued *)
    intros x H. rewrite <- unique_existence.
    split. apply domE in H...
    intros y1 y2 H1 H2.
...
Proof with nauto.
  intros n Hn.
  ω_induction n.
  - exists 0. split... exists 0. split... rewrite add_0_r...
...
Proof with eauto.
  ...
  - intros m Hm n Hn p Hp q Hq. apply CPrdI; apply add_ran...
  - intros a Ha b Hb.
...
Proof with auto.
  ...
  apply SepI. apply CPrdI; apply CPrdI;
    try apply CPrdI; try apply add_ran... zfc_simple...
Qed.
...
Proof with eauto.
  ...
  apply SepI. apply CPrdI; apply CPrdI; apply add_ran...
...
Theorem intAdd_0_r : ∀a ∈ ℤ, a + Int 0 = a.
Proof with nauto.
  intros a Ha. apply pQuotE in Ha as [m [Hm [n [Hn Ha]]]].
  subst a. unfold Int. rewrite intAdd_m_n_p_q, add_0_r, add_0_r...
Qed.

Corollary intAdd_0_l : ∀a ∈ ℤ, Int 0 + a = a.
Proof with nauto.
  intros a Ha. rewrite intAdd_comm, intAdd_0_r...
Qed.
...
Proof with nauto.
  ...
  rewrite add_0_r, add_0_l, add_comm; try apply add_ran...
Qed.
...
Proof with auto.
  ...
  rewrite <- (intAdd_0_r b), <- (intAdd_0_r b')...
...
Proof with nauto.
  ...
  rewrite add_0_r... subst. rewrite add_comm... zfc_simple...
Qed.
...
Proof with neauto.
  ...
  - destruct (classic (m = n)) as [Hmn|Hmn].
    ...
    + apply nat_connected in Hmn as []...
      * apply nat_subtr' in H as [b [Hb [Heq _]]]...
  ...
  - intros x1 x2 H1 H2.
    ...
    apply preIntProjE in H2 as [p2 [Hp2 [q2 [Hq2 [Hx2 [H2 []]]]]]];
      ...
      apply planeEquiv in H1; apply planeEquiv in H2;
      unfold IntEq in *...
    + split... rewrite add_0_l in *... subst n.
      eapply add_cancel'; revgoals...
    + rewrite add_0_l in H1...
      rewrite add_0_r in H2... subst m.
      rewrite add_assoc, add_comm,
        add_assoc in H1; [|auto; apply add_ran..]...
      apply add_a_b_eq_a in H1...
      apply add_eq_0 in H1 as []... apply add_ran...
    + rewrite add_0_r in H1...
      rewrite add_0_l in H2... subst m.
      rewrite add_assoc, add_comm,
        add_assoc in H2; [|auto; apply add_ran..]...
      apply add_a_b_eq_a in H2...
      apply add_eq_0 in H2 as []... apply add_ran...
    + split... rewrite add_0_r in *... subst m.
      eapply add_cancel; revgoals...
Qed.
...
Proof with nauto.
  ...
  apply int_ident... rewrite (pred 1), add_suc, add_0_r, add_0_l...
Qed.
