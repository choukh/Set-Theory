...
Proof with neauto.
  ...
  - rewrite ordExp_limit... ext ξ Hξ.
    ...
    + rewrite one in Hξ. apply SingE in Hξ. subst.
      eapply FUnionI. apply ord_nq_0_gt_0...
...
Proof with auto.
  ...
  apply ordAdd_normal... apply ord_nq_0_gt_0...
Qed.
...
Proof with neauto.
  ...
  apply n. eapply ordExp_eq_0... unfold OrdExp.
  destruct (ixm (α = 0))... exfalso...
Qed.
...
Proof with nauto.
  ...
  - apply ord_pow_limit_r...
    apply gt_1_iff_nq_0_1... split... intros H.
...
Proof with eauto.
  ...
  apply ordAdd_preserve_lt... apply ord_nq_0_gt_0...
Qed.
...
Proof with eauto.
  ...
  rewrite ordMul_0_r... apply ord_nq_0_gt_0...
...
Proof with neauto.
  ...
  destruct (classic (α = 1)) as [|Hα1]. {
    ...
    - intros γ [Hγ [δ [[Hδ [ρ [[Hρ [Heq [Hδ0 _]]] _]]] _]]].
      symmetry. contra. apply ord_nq_0_gt_0 in H...
  ...
  rewrite ordExp_0_r... apply gt_1_iff_nq_0_1...
...
Proof with eauto.
  ...
  - ext ξ Hξ.
    + rewrite ordAdd_limit in Hξ...
      ...
      rewrite IH in Hξ... eapply ord_trans...
      apply ordAdd_normal... apply ordAdd_normal...
    + rewrite ordAdd_limit in Hξ; revgoals...
      intros H. apply H0. apply ordAdd_eq_0 in H as []...
      apply ord_sum_limit...
      apply FUnionE in Hξ as [δ [Hδ Hξ]].
      ...
      rewrite <- IH in Hδ...
      eapply ord_trans... eapply ord_trans...
      apply ordAdd_preserve_lt...
Qed.
