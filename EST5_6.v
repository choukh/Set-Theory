...
Lemma realLeq_both_side_nonNegMul : ∀ x y z ∈ ℝ,
...
Proof with neauto.
  ...
  assert (Hs: s ∈ ℚ) by (repeat (apply ratMul_ran; nauto)).
  assert (Hpp': ratPos p'). {
  ...
  - assert (Hnt: -t ∈ ℚ) by (apply ratAddInv_ran; auto).
    ...
    * exists t. repeat split...
      ...
      eapply realE2_2; revgoals...
    * eapply ratLt_both_side_add; swap 1 3; [apply Hnt|idtac..]...
      rewrite ratAdd_assoc, ratAddInv_annih, ratAdd_ident...
      rewrite <- (ratMul_ident' t) at 2...
      rewrite <- ratMul_addInv_l, <- ratMul_distr'...
      unfold s. rewrite ratMul_assoc...
    ...
    + cut (s + t <𝐪 p ⋅ (r / Rat 2)). intros Hlt.
      ...
      * assert (H1: r / Rat 3 ∈ ℚ) by (apply ratMul_ran; nauto).
        ...
        rewrite (ratAdd_comm p), ratMul_assoc, ratMul_distr';
          nauto; [|apply ratAdd_ran]...
        repeat rewrite <- ratMul_assoc...
        rewrite ratMul_addInv_l, ratMul_ident', ratMul_addInv_l,
          <- ratAdd_assoc; nauto; [|repeat apply ratMul_ran]...
