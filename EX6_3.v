...
Proof with nauto.
  ...
  apply lt_iff_leq_suc in H2; [|apply ω_inductive|]...
...
Proof with neauto; try congruence.
  ...
  assert (Hapw: ∀x ∈ A, f[x] ∈ ω). {
    intros x Hx. apply (ω_trans _ (m⁺⁺))... apply Hap...
  }
  assert (Happ: ∀x ∈ A, f[x] ≠ m⁺ → f[x]⁺ ∈ m⁺⁺). {
    intros x Hx Hnq. apply Hap in Hx as H.
    apply (suc_preserve_lt (f[x]))... apply Hapw...
  ...
  assert (Hg: g: A ⟺ A). {
    ...
    - intros x1 H1 x2 H2 Heq.
      ...
      + apply injectiveE in Heq... apply suc_injective in Heq...
        apply injectiveE in Heq... apply Hapw... apply Hapw...
        rewrite Hdf'. apply Happ...
        rewrite Hdf'. apply Happ...
    - intros y Hy. ω_destruct (f[y]); [| |apply Hapw]...
      ...
      + assert (Hn'm: n' ∈ m⁺⁺). {
          ...
          rewrite <- Hn'eq. eapply ap_ran...
        }
        exists (f⁻¹[n']). split. eapply ap_ran...
        destruct (ixm (f[(f⁻¹)[n']] = m⁺)).
        * exfalso. rewrite inv_ran_reduction in e...
          apply Hap in Hy. rewrite <- e, <- Hn'eq in Hy.
          apply (lt_irrefl (f[y]))...
        * rewrite inv_ran_reduction, <- Hn'eq, inv_dom_reduction...
  }
  exists g. apply SepI.
  ...
  - intros a Ha Heq. unfold g in Heq.
    ...
    + assert (f[f⁻¹[f[a]⁺]] = f[a]) by congruence.
      ...
      * apply (suc_neq_n (f[a]))... apply Hapw...
...
Proof with eauto; try congruence.
  ...
  assert (Hg: g: A ⟺ A). {
    ...
    - intros x Hx.
      ...
      + apply BUnionI1. apply CProdI... apply Hπ1...
    - intros x1 H1 x2 H2 Heq.
    ...
    - intros y Hy.
      ...
      apply SingE in Hb; subst b. {
        ...
        - assert (Hp: <a, 1> ∈ dom f). {
            rewrite Hdf. apply BUnionI2. apply CProdI...
          }
        ...
        exists (f[<a, 0>]). split.
        - eapply ap_ran... apply BUnionI1. apply CProdI...
        - assert (Hp: <a, 0> ∈ dom f). {
...
Proof with neauto; try congruence.
  ...
  assert (Hdj: ∀a ∈ A, (A - ⎨a⎬) ∩ ⎨a⎬ = ∅). {
    intros a Ha. apply ExtAx. split; intros Hx; [exfalso|exfalso0].
    apply BInterE in Hx as [H1 H2]. apply SepE in H1 as []...
  }
  assert (HF'a: ∀a ∈ A,
    (F' a : A - ⎨a⎬ ⟺ A - ⎨a⎬) ∧
    ∀x ∈ A - ⎨a⎬, (F' a)[x] ≠ x
...
Proof with eauto.
  ...
  apply cardGeq_aleph0_is_infinite. unfold CardFactorial...
...
Proof with neauto; try congruence.
  ...
  assert (HSf: ∀f ∈ A ⟶ 2, 2 ≤ |O f| → Shuffle (O f) ∈ 𝒮). {
    intros f Hf H2. apply ReplAx. exists (O f). split...
    apply SepI... apply HOf...
  }
  ...
  assert (Hdj: ∀f ∈ A ⟶ 2, O f ∩ I f = ∅). {
    intros f Hf. apply ExtAx. split; intros Hx; [exfalso|exfalso0].
  ...
  assert (HeqA: ∀f ∈ A ⟶ 2, A = O f ∪ I f). {
    ...
    - apply BUnionE in Hx as []; apply SepE in H as []...
  }
  ...
  - intros f1 H1 f2 H2 Heq. unfold G' in Heq.
    ...
    + apply Hnq0 in H10... apply Hnq0 in H20...
      apply Hfx in H1 as Hr1. apply arrow_iff in H1 as [Hf1 [Hd1 _]].
      apply Hfx in H2 as Hr2. apply arrow_iff in H2 as [Hf2 [Hd2 _]].
      eapply func_ext_intro... intros x Hx. rewrite Hd1 in Hx.
      apply H10 in Hx as H1. apply H20 in Hx as H2.
      pose proof (Hr1 x Hx) as []; pose proof (Hr2 x Hx) as []...
    + destruct (ixm (|O f2| = 1)) as [H21|H21].
      ...
      * exfalso.
        ...
        apply ident_ap. apply SepE in Ha as []...
    ...
    + destruct (ixm (|O f1| = 1)) as [H11|H11];
      ...
      * apply op_iff in Heq as [H _].
        ...
        apply Hfx in H1 as Hfx1.
        apply Hfx in H2 as Hfx2.
        apply arrow_iff in H1 as [Hf1 [Hd1 Hr1]].
        apply arrow_iff in H2 as [Hf2 [Hd2 Hr2]].
        apply func_ext_intro...
        intros x Hx. rewrite Hd1 in Hx...
        pose proof (Hfx1 x Hx) as [Hf10|Hf11];
        pose proof (Hfx2 x Hx) as [Hf20|Hf21]... {
      ...
      * apply op_iff in Heq as [_ H]. exfalso. eapply suc_neq_0...
      * apply op_iff in Heq as [H _].
        apply Hfx in H1 as Hfx1. assert (H1' := H1).
        apply Hfx in H2 as Hfx2. assert (H2' := H2).
        apply arrow_iff in H1' as [Hf1 [Hd1 Hr1]].
        apply arrow_iff in H2' as [Hf2 [Hd2 Hr2]].
        apply func_ext_intro...
        intros x Hx. rewrite Hd1 in Hx...
...
Proof with nauto.
  ...
  - apply SepE in Hx as [Hx [_ [Hd _]]]. apply SepE in Hx as [Hx _].
    ...
    rewrite cprod_single_single, power_single in Hx.
  ...
  exists F. apply meta_injective. {
    ...
    - apply ExtAx. split; intros Hx.
      + apply domE in Hx as [y Hp].
        ...
        * apply Hrg...
        * rewrite dom_ident in H. apply SepE in H as []...
    ...
    - apply ExtAx. intros y. split; intros Hy.
      + apply ranE in Hy as [x Hp].
        ...
        * apply Hrg...
        * rewrite ran_ident in H. apply SepE in H as []...
