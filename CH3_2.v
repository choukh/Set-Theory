...
Proof with eauto.
  ...
  - intros [Hr [Hsy Htr]]. apply ExtAx. intros p. split; intros Hp.
    + apply relE in Hp as Heq... rewrite Heq in *.
...
Proof with eauto.
  ...
  - intros x Hx. apply SepI. apply CProdI...
    ...
    eapply ranI... apply funcDomE2... rewrite Hd...
...
Proof with eauto.
  ...
  - intros x y z H1 H2.
    ...
    + subst C. apply SepI.
      ...
      exists B. split... rewrite π1_correct, π2_correct...
    + exfalso. apply H. eapply disjointE... apply Hdj...
Qed.
...
Proof with eauto; try congruence.
  ...
  - apply quotE in HX as [a [Ha Heq]]. subst X.
    ...
    + apply eqvcE in Hx. apply SepE in Hx as [_ [C [HC [Hac Hx]]]].
      rewrite π1_correct, π2_correct in *.
      cut (B = C)... eapply disjointE... apply Hdj...
  - assert (HXs := HX). apply Hsub in HXs as [[a Ha] HXs].
    ...
    + apply eqvcE in Hx. apply SepE in Hx as [_ [B [HB [H1 H2]]]].
      rewrite π1_correct, π2_correct in *.
      cut (X = B)... eapply disjointE... apply Hdj...
...
Proof with eauto.
  ...
  assert (Hf': is_function F'). {
    ...
    - intros y1 y2 Hy1 Hy2. apply domE in H as [y0 Hy0].
      ...
      apply funcDomE2 in Hd1... apply funcDomE2 in Hd2...
  ...
  assert (Hrf': ran F' ⊆ A/R). {
    ...
    rewrite <- Hdf in Ha. apply funcDomE2 in Ha as Hp...
  ...
  - apply Hrf. eapply ranI... apply funcDomE2...
...
Proof with eauto.
  ...
  eapply eqvc_ident...
  - apply Hr. eapply ranI. apply funcDomE2...
...
Proof with eauto.
  ...
  - intros y Hy. split. apply ranE in Hy...
    ...
    apply apI in H1... apply apI in H2... subst y.
  ...
  - intros x1 Hx1 x2 Hx2 Hpf. destruct (classic (x1 = x2)).
    + exfalso. apply Hir. exists (f[x2]). split.
      apply Hr. eapply ranI. apply funcDomE2... rewrite Hd...
      rewrite H0 in Hpf...
    + apply Hco in H0 as []...
