...
Lemma ε_lt_ε_exp_ε : ∀α ⋵ 𝐎𝐍, ε α ∈ ε α ^ ε α.
Proof with nauto.
  intros α Hα.
  eapply (ord_trans _ _ _ (ε α ^ 2)); revgoals.
  apply ordExp_preserve_lt...
  rewrite pred, ordExp_suc, ordExp_1_r...
  eapply (ord_trans _ _ _ (ε α ⋅ 2)); revgoals.
  apply ordMul_preserve_lt...
  rewrite pred, ordMul_suc, ordMul_1_r...
  eapply (ord_trans _ _ _ (ε α + 1)); revgoals.
  apply ordAdd_preserve_lt... rewrite ordAdd_1_r...
  Unshelve. 1-3:auto.
Qed.
...
Proof with neauto; try congruence.
  ...
  - rewrite ordTet_suc, <- zero, ordTet_0...
    apply ε_lt_ε_exp_ε...
  - rewrite ordTet_suc, ordTet_suc...
    apply ordExp_preserve_lt...
Qed.
