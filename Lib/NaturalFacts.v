...
Proof with auto; try congruence.
  ...
  apply finite_set_remove_one_member in Hcd...
...
Proof with nauto.
  ...
  - pose proof (nat_neq_suc m Hm) as Hnq.
    assert (Hstar: ∀k ∈ N, k ∉ {m⁺,} → k ⊆ m). {
      ...
      apply lt_iff_suc_le in Hmk...
      apply le_iff_sub in Hmk; [|apply ω_inductive|]...
...
Proof with neauto; try congruence.
  ...
  assert (Hn0': n0 ∈ N - ran F). {
    ...
    pose proof (Hle x Hx) as Hn0x. apply le_iff_sub in Hn0x...
