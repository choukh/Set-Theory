...
Proof with eauto.
  ...
  - apply e_elim in Hx as [s [Hs [Hst [Heq Hx]]]]; [|apply HAsub]...
    assert (Hst': (s <ᵣ t) (R S)). {
      rewrite HRsub. apply SepI... apply CPrdI...
      contra.
...
Proof with eauto; try congruence.
  ...
  - apply UnionAx in Hlt as [p [Hp Hlt]].
    ...
    + assert (HxV: x ∈ A V). apply Hsub...
      ...
      * rewrite H. apply SepI... apply CPrdI...
...
Proof.
  ...
  apply CPrdI; apply UnionAx; exists (A S); split; auto;
