...
Proof with nauto.
  ...
  rewrite (pred 2), mul_m_n, mul_ident, add_m_n, <- add_suc;
    repeat apply ω_inductive...
  rewrite (pred 2), add_m_n, <- add_suc;
    repeat apply ω_inductive...
Qed.
...
Proof with nauto.
  ...
  - repeat rewrite pred.
    ...
    repeat rewrite add_m_n; try rewrite add_ident;
      repeat apply ω_inductive...
  - repeat rewrite pred.
    repeat rewrite mul_m_n; repeat apply ω_inductive...
    rewrite mul_0_r, add_ident; repeat apply ω_inductive...
    repeat (repeat rewrite add_m_n; try rewrite add_ident;
      repeat apply ω_inductive)...
  - repeat rewrite pred.
    repeat rewrite add_m_n; try rewrite add_ident;
      repeat apply ω_inductive...
