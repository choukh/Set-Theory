...
Proof with neauto.
  ...
  - exfalso. eapply realLt_not_refl; revgoals...
  - apply realNonNeg_not_neg in Hnny...
...
Proof with auto.
  ...
  destruct (ixm (realPos x)); apply SepE in Hp as []...
Qed.
...
Theorem realLt_both_side_mul : ∀ x y z ∈ ℝ,
...
Proof with nauto.
  ...
  apply realLt_both_side_add... apply realMul_ran...
  ...
  rewrite <- (realAddInv_annih x)... apply realLt_both_side_add...
Qed.
...
Proof with auto.
  ...
  apply realLt_both_side_mul... apply realMul_ran...
...
Proof with neauto.
  ...
  - assert (Hsr: Realq s ∈ ℝ) by (apply real_q; auto).
    apply realLtE in Hlt as [H0 [_ [Hsub Hnq]]].
  ...
  - apply realLt; [apply real_q..|]... split.
...
Proof with eauto.
  ...
  - apply realq_lt in H... rewrite Heq in H.
    eapply realLt_not_refl; revgoals... apply real_q...
  - apply realq_lt in H... rewrite Heq in H.
    eapply realLt_not_refl; revgoals... apply real_q...
Qed.
...
Proof with nauto.
  ...
  - apply SepE in Ht as [Ht Hlt].
    ...
    assert (Hpε: ratPos ε). {
      ...
      rewrite <- (ratAddInv_annih t)... apply ratLt_both_side_add...
    }
    replace t with ((r - ε) + (s - ε)).
    apply realAddI2. apply real_q... apply real_q...
    + apply SepI... apply ratAdd_ran...
      rewrite <- (ratAdd_ident r) at 2...
      apply ratLt_both_side_add'... apply ratPos_neg...
    + apply SepI... rewrite <- (ratAdd_ident s) at 2...
      apply ratLt_both_side_add'... apply ratPos_neg...
    + rewrite ratAdd_assoc, (ratAdd_comm (-ε)), ratAdd_assoc,
        <- ratAdd_assoc, <- ratAddInv_sum; auto; [|apply ratAdd_ran]...
      unfold ε. rewrite <- ratMul_distr, ratAdd_r2_r2_1, ratMul_ident,
        ratAddInv_diff, (ratAdd_comm t), <- ratAdd_assoc,
        ratAddInv_annih, ratAdd_ident'; nauto; apply ratAddInv_ran...
...
Proof with neauto.
  ...
  - apply SepE in Ht as [Ht Hlt].
    ...
    rewrite <- (ratMul_ident t), <- (ratMulInv_annih p),
      (ratMul_comm p), <- ratMul_assoc, (ratMul_comm (t/p))...
    apply realNonNegMulI1; auto; swap 2 3.
    + apply SepI... + left...
    + apply SepI... rewrite <- (ratMul_ident s),
        <- (ratMulInv_annih p), <- ratMul_assoc...
      apply ratLt_both_side_mul... apply ratMul_ran...
      rewrite <- (ratMul_ident p), <- (ratMulInv_annih s),
        <- ratMul_assoc, (ratMul_comm p) in Hp1...
      apply ratLt_both_side_mul in Hp1...
      apply ratMul_ran... apply ratPos_mulInv...
...
Proof with nauto.
  ...
  - apply realq_lt in Hnx as Hngr... apply realNeg_nonPos in Hnx...
    ...
    + apply realq_nonNegMul; auto; left.
      apply ratLt_addInv in Hngr... rewrite ratAddInv_0 in Hngr...
      apply ratLt_addInv in Hngs... rewrite ratAddInv_0 in Hngs...
  ...
  - apply realq_lt in Hnx as Hngr... apply realNeg_nonPos in Hnx...
    ...
    apply realq_nonNegMul... left. apply ratLt_addInv in Hngr...
    rewrite ratAddInv_0 in Hngr... apply realq_leq...
  - apply realNonNeg_not_neg in Hnnx...
    apply realq_lt in Hny as Hngs... apply realNeg_nonPos in Hny...
    ...
    left. apply ratLt_addInv in Hngs... rewrite ratAddInv_0 in Hngs...
...
Proof with eauto.
  intros A x Hx z Hz Hsub Hxz [Hup Hsup].
  ...
  apply Hsup in Hupx as []; subst; exfalso;
...
Proof with neauto.
  ...
  assert (Hbnd: boundedAbove RealLt A). {
    exists y. intros w Hw. apply ReplAx in Hw as [a [Ha Heq]].
    apply Hleq in Ha. congruence.
  }
  pose proof (reals_boundedAbove_has_sup A Hi Hsub Hbnd) as [s [Hs Hsup]].
  exfalso. clear H Hleq Hi Hbnd.
  assert (Hnx: -x ∈ ℝ) by (apply realAddInv_ran; auto).
  assert (Hlt: s - x <𝐫 s). {
    rewrite realAdd_comm... rewrite <- (realAdd_ident' s) at 2...
    apply realLt_both_side_add... apply realPos_neg...
  }
  assert (Hsup' := Hsup).
  eapply realLt_sup in Hsup' as [z [Hz H]]; revgoals; eauto; [apply realAdd_ran|]...
  ...
  destruct Hsup as [Hup _]. apply Hup. apply ReplAx.
  exists (a + Int 1)%z. split...
Qed.
...
Proof with neauto.
  ...
  apply realLt_both_side_subtr in H1; auto;
  ...
  { intros d Hd. apply SepE in Hd as []... }
  { exists (-c)%z. intros d Hd. apply SepE in Hd as [Hd Hlt].
  ...
  eapply realLt_both_side_mul in Hlt1; revgoals; [apply Hpra|..]...
  eapply realLt_both_side_mul in Hlt2; revgoals; [apply Hpra|..]...
