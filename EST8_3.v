...
Proof.
  ...
  subst. zfcrewrite. apply CProdI; apply CProdI; auto.
Qed.
...
Proof.
  ...
  apply op_iff in Hyz as []; subst. zfcrewrite.
  apply op_iff in H as []; subst.
  apply ReplAx. exists <a, d>. split; zfcrewrite. eapply Htr; eauto.
Qed.
...
Proof.
  ...
  apply CProdE1 in H as [a [Ha [b [Hb H]]]]. subst. zfcrewrite.
...
Proof with auto.
  ...
  left. apply ReplAx. exists <a, c>. split; zfcrewrite.
  right. apply ReplAx. exists <c, a>. split; zfcrewrite.
Qed.
...
Proof with auto.
  ...
  - apply ReplAx. exists <x, y>. split... zfcrewrite.
...
Proof with eauto; try congruence.
  ...
  assert (Hbi: F: Dom ⟺ Ran). {
    ...
    - intros y Hy. apply BUnionE in Hy as [];
      ...
      + exists <f⁻¹[a], 0>. split. apply BUnionI1.
        apply CProdI... eapply ap_ran... zfcrewrite.
  ...
  - apply HbrS in Hp as H.
    ...
    exists <f[s], f[t]>. split; zfcrewrite. apply Hopf...
  ...
  - apply HbrT in Hp as H.
    ...
    exists <g[s], g[t]>. split; zfcrewrite. apply Hopg...
  - apply CProdE2 in Hxy as [H _];
    apply CProdE2 in H as [_ H]; apply SingE in H...
  - apply HbrS' in Hp as H.
    apply CProdE1 in H as [s [Hs [t [Ht H]]]].
    subst. zfcrewrite. subst.
    apply BUnionI1. apply BUnionI1. apply ReplAx.
    exists <a, c>. split; zfcrewrite. apply Hopf...
  - apply CProdE2 in Hxy as [_ H];
    apply CProdE2 in H as [_ H]; apply SingE in H...
  - apply BUnionI2. apply CProdI; apply CProdI...
  - apply CProdE2 in Hxy as [_ H];
  ...
  - apply HbrT' in Hp as H.
    ...
    subst. zfcrewrite. subst.
    apply BUnionI1. apply BUnionI2. apply ReplAx.
    exists <a, c>. split; zfcrewrite. apply Hopg...
  - apply CProdE2 in Hxy as [H _];
    apply CProdE2 in H as [_ H]; apply SingE in H...
Qed.
...
Proof with neauto; try congruence.
  ...
  assert (Hbi: F: Dom ⟺ Ran). {
    ...
    - intros x Hx.
      apply BUnionE in Hx as []; destruct (ixm (π2 x = 0));
      apply CProdE1 in H as [a [Ha [b [Hb Heq]]]];
      apply SingE in Hb; subst; zfcrewrite; simpl in Ha.
    ...
    - intros y Hy. destruct (classic (y ∈ n)).
      ...
      + assert (Hyw: y ∈ ω). eapply ω_trans... apply add_ran...
        ...
        zfcrewrite. destruct (ixm (Embed 1 = 0))...
  }
  apply bijection_is_func in Hbi as HF. destruct HF as [HF _].
  ...
  [(apply BUnionE in Hxy as [Hxy|Hxy]; [
    ...
    apply op_iff in H2 as [H2 H2']; subst; zfcrewrite
  |])..| | | |].
  - apply binRelE1 in Hp as [s [Hs [t [Ht [Hp Hst]]]]]. subst. zfcrewrite.
    apply binRelI; [apply lt_add_enlarge..|]...
  - apply CProdE2 in Hxy as [_ H].
    apply CProdE2 in H as [_ H]. apply SingE in H...
  - assert (Hcw: c ∈ ω). eapply ω_trans...
    subst. zfcrewrite. apply binRelI. apply lt_add_enlarge...
  ...
  - apply binRelE3 in Hxy. apply BUnionI1. apply BUnionI1.
    apply ReplAx. exists <a, c>. split; zfcrewrite. apply binRelI...
  ...
  - apply binRelE3 in Hxy. apply BUnionI1. apply BUnionI2.
    apply ReplAx. exists <a, c>. split; zfcrewrite.
...
Proof with neauto; try congruence.
  ...
  |])..| | | |].
  - apply binRelE1 in Hp as [s [Hs [t [Ht [Hp Hst]]]]].
    subst. zfcrewrite. apply binRelI; [apply BUnionI1..|]...
  - apply CProdE2 in Hxy as [_ H].
    apply CProdE2 in H as [_ H]. apply SingE in H...
...
Proof with neauto; try congruence.
  ...
  - apply binRelE1 in Hp as [s [Hs [t [Ht [Hp Hst]]]]].
    ...
    subst. zfcrewrite. rewrite ω_embed_n, ω_embed_n...
    apply intLt... rewrite add_ident, add_ident...
  ...
  - assert (Ha': (a + 1)%n ∈ ω). apply add_ran...
    ...
    apply BUnionI1. apply BUnionI2. apply ReplAx.
    exists <a, c>. split; zfcrewrite. apply binRelI...
Qed.
