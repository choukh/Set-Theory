...
Proof with eauto.
  ...
  apply SepI. apply CProdI... zfc_simple. eapply nat_trans...
Qed.

Lemma Lt_irrefl : irrefl Lt.
Proof with eauto.
  intros k Hp. apply SepE in Hp as [Hp Hlt].
  apply CProdE2 in Hp as [Hk _]. zfc_simple. eapply nat_irrefl...
Qed.
...
Proof with nauto.
  ...
  + ω_destruct k.
    * subst. right. apply SepI; zfc_simple. apply CProdI...
      apply ω_inductive... apply suc_has_0...
    * subst. assert (m ≠ n') by congruence.
      apply IH in H as []...
      left. apply binRelE3 in H.
      apply SepI; zfc_simple. apply CProdI... apply ω_inductive...
