...
Proof with nauto.
  ...
  - assert (Hmw: m⁺ ∈ ω) by (apply ω_inductive; nauto).
    ...
    rewrite Nat.add_succ_r, (suc_isomorphic_n m), proj_embed_id...
...
Proof with nauto.
  ...
  - assert (Hmw: m⁺ ∈ ω) by (apply ω_inductive; nauto).
    ...
    rewrite Nat.mul_succ_r, (suc_isomorphic_n m), proj_embed_id...
...
Proof with nauto.
  ...
  - assert (Hmw: m⁺ ∈ ω) by (apply ω_inductive; nauto).
    ...
    rewrite Nat.pow_succ_r', (suc_isomorphic_n m), proj_embed_id...
    rewrite exp_m_n, IHm...
...
Proof with nauto.
  ...
  - induction m.
    ...
    + intros. apply PeanoNat.Nat.le_succ_r in H as []; [|subst]...
      eapply sub_tran... rewrite suc_isomorphic_n, proj_embed_id.
  ...
  - rename m into k. pose proof (embed_ran k) as Hk.
    ...
    + assert (Hmw: m⁺ ∈ ω) by (apply ω_inductive; auto).
      ...
      * apply lt_suc_iff_sub in H... apply IH in H.
        rewrite suc_isomorphic_ω, embed_proj_id...
