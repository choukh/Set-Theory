  ...
  - ω_induction n.
    ...
    + destruct IH.
      ...
      * left. destruct H as [k [Hk Heq]].
        ...
        rewrite Heq, (pred 1), add_suc, add_ident...
        rewrite suc, suc, mul_suc...
        rewrite (add_comm 2)...
        rewrite (add_assoc (2⋅k))...
        cut (1 + 1 = 2); try congruence...
        rewrite pred, add_suc, add_ident... apply mul_ran...
...
Proof with neauto.
  ...
  - apply (IH d Hd) in Hnq0 as [q [Hq [r [Hr [Heq Hrd]]]]]...
    ...
    + subst d. exists q⁺. split. apply ω_inductive...
      ...
      rewrite add_ident, mul_suc, add_comm, add_suc; try apply mul_ran...
...
Proof with eauto.
  ...
  - intros a Ha. apply HA in Ha as Haw. rewrite <- HU in Ha.
    ...
    + exfalso. apply leq_iff_lt_suc in H...
      apply (nat_not_leq_gt b Hbw a Haw)...
...
Proof with eauto.
  ...
  - destruct (classic (m⁺ = a)).
    ...
    apply leq_iff_lt_suc in Hc... eapply nat_not_leq_gt; revgoals...
...
Proof with eauto; try congruence.
  ...
  assert (Hhf: is_function h). {
    ...
    - rewrite H11 in Hxm2. exfalso.
      ...
      eapply (leq_iff_not_gt m Hm (m + b1))...
      apply add_ran... eapply leq_add_enlarge...
...
Proof with eauto; try congruence.
  ...
  - ω_destruct j2; subst j2... exfalso.
    ...
    eapply nat_not_leq_gt; revgoals. apply Hlt1.
  ...
  - ω_destruct j2; subst j2.
    + exfalso. rewrite mul_0_r, add_ident' in Heq...
      ...
      eapply nat_not_leq_gt; revgoals. apply Hlt2.
      apply leq_mul_enlarge...
...
Proof with neauto.
  ...
  - exfalso. rewrite add_ident in Hx...
    eapply nat_not_leq_gt; revgoals... eapply ω_trans...
  - assert (Hxw: x ∈ ω). {
