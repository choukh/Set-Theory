...
Require Export ZFC.Elements.EST5_2.
...
Proof with neauto.
  ...
  rewrite add_0_r, add_0_l in H... eapply suc_neq_0...
Qed.
...
Proof with nauto.
  ...
  split; (apply CompI; [apply pQuotI; auto|]); apply SingNI;
    ...
    apply int_ident in H; nauto; rewrite add_0_r, add_0_l in H;
...
Proof with neauto.
  ...
  - intros a Ha b Hb.
    ...
    rewrite intMul_1_r, intMul_1_r... split...
    rewrite intMul_comm, intMul_0_r_r, intAdd_0_r...
Qed.
...
Proof with nauto.
  ...
  rewrite intMul_1_r, intMul_1_r, intAdd_1_2...
Qed.
...
Theorem ratAdd_0_r : ∀r ∈ ℚ, r + Rat 0 = r.
Proof.
  intros r Hr.
  apply pQuotE in Hr as [a [Ha [b [Hb Hr]]]]. subst r.
  unfold Rat. rewrite ratAdd_a_b_c_d, intMul_1_r, intMul_1_r,
    intMul_0_l, intAdd_0_r; nauto; nz.
Qed.

Corollary ratAdd_0_l : ∀r ∈ ℚ, Rat 0 + r = r.
Proof.
  intros r Hr. rewrite ratAdd_comm, ratAdd_0_r; nauto.
Qed.
...
Proof with nauto.
  ...
  rewrite intMul_1_r, intMul_0_l, intMul_addInv_l,
...
Proof with auto.
  ...
  rewrite <- (ratAdd_0_r s), <- (ratAdd_0_r s')...
...
Proof with nauto.
  ...
  - apply intLt in Hpos...
    rewrite add_0_r, add_0_l in Hpos...
    rewrite add_0_l in H2... rewrite <- H2 in Hpos.
    rewrite <- (add_0_r m) in Hpos at 2...
...
Proof with nauto.
  ...
  rewrite intMul_1_r, intMul_1_r, intMul_1_r, intAdd_2_n3...
Qed.
...
Proof with neauto.
  ...
  - intros r Hr s Hs.
    ...
    rewrite intMul_1_r, intMul_1_r; nz...
Qed.
...
Proof with nauto.
  ...
  rewrite intMul_0_r_r, intMul_1_r, intMul_0_l...
  rewrite intMul_1_r; nz.
Qed.
...
Proof with nauto.
  ...
  rewrite intMul_2_n2, intMul_1_r...
Qed.
...
Lemma ratMul_1_r : ∀r ∈ ℚ, r ⋅ Rat 1 = r.
Proof with nauto.
  intros r Hr.
  apply pQuotE in Hr as [a [Ha [b [Hb Hr]]]]. subst r.
  unfold Rat. rewrite ratMul_a_b_c_d...
...
Lemma ratMul_1_l : ∀r ∈ ℚ, Rat 1 ⋅ r = r.
Proof.
  intros a Ha. rewrite ratMul_comm, ratMul_1_r; nauto.
Qed.
...
Proof.
  intros s Hs. rewrite ratMul_comm, ratMul_0_r_r; nauto.
Qed.
...
Proof with nauto.
  ...
  rewrite intMul_1_r, intMul_0_l in H0; nz...
Qed.
...
Proof with neauto.
  ...
  rewrite intMul_1_r, intMul_1_r in H...
...
Proof with auto.
  ...
  - rewrite ratMul_a_b_c_d; nz... unfold Rat.
    ...
    rewrite intMul_1_r, intMul_1_l, intMul_comm;
      auto; nz; mr; nz.
Qed.
...
Proof with auto.
  ...
  rewrite <- (ratMul_1_r q), <- (ratMul_1_r q'); nz_q...
  rewrite <- H2 at 1. rewrite <- H1.
...
Proof with nauto.
  ...
  rewrite ratAdd_a_b_c_d, intMul_1_l...
  ...
  rewrite (pred 2), mul_suc, mul_1_r, add_suc, <- suc;
...
Proof with nauto.
  unfold Rat. repeat rewrite ratMulInv...
  rewrite ratAdd_a_b_c_d, intMul_1_l, intMul_1_l...
  unfold Int. rewrite intAdd_m_n_p_q, intMul_m_n_p_q...
  rewrite mul_0_l, mul_0_l, mul_0_r, add_0_r...
  ...
  - repeat rewrite pred.
    ...
    repeat rewrite add_suc; try rewrite add_0_r;
      repeat apply ω_inductive...
  - repeat rewrite pred.
    repeat rewrite mul_suc; repeat apply ω_inductive...
    rewrite mul_0_r, add_0_r; repeat apply ω_inductive...
    repeat (repeat rewrite add_suc; try rewrite add_0_r;
      repeat apply ω_inductive)...
  - repeat rewrite pred.
    repeat rewrite add_suc; try rewrite add_0_r;
      repeat apply ω_inductive...
