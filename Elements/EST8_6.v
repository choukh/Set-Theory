...
Require Export ZFC.Elements.EST8_5.
Import OrderType.
Import WoStruct.
...
Proof with nauto.
  ...
  - rewrite ordAddₜ_suc, IH, suc, suc, add_assoc... apply add_ran...
Qed.
...
Proof with auto.
  ...
  - rewrite A_WOₒAdd, A_WOₒAdd...
    ...
    + apply BUnionI1...
    + apply CPrdE1 in H as [a [Ha [b [Hb H0]]]].
    ...
    ext Hx. {
      ...
      - apply CPrdE1 in Hx as [a [Ha [b [Hb Hx]]]].
        ...
        + apply BUnionI2. apply CPrdI...
          ...
          apply SingE in Hd. subst. apply CPrdI...
      ...
      - apply BUnionI1. apply BUnionI2.
        ...
        apply CPrdE2 in H1 as [H1 _].
        apply CPrdE2 in H2 as [H2 _].
        apply ReplAx. exists <a, b>. split.
        apply binRelI... zfc_simple.
      - apply BUnionI2.
        apply CPrdE1 in Hx as [a [Ha [b [Hb Hx]]]]. subst.
        apply CPrdI...
        apply CPrdE2 in H2 as [_ H].
        apply BUnionE in H as []... exfalso.
        apply CPrdE1 in Hb as [c [Hc [d [Hd H1]]]].
        apply SingE in Hd. subst.
        apply CPrdE2 in H as [_ H]. apply SingE in H. nauto.
    }
  - intros x Hx y Hy.
...
Proof with eauto.
  ...
  - apply UnionAx in Hx as [p [Hp Hx]].
    ...
    apply SingE in Hb. subst. apply CPrdI... eapply ord_trans...
...
Proof with eauto.
  ...
  - apply BUnionE in Hx as [Hx|Hx];
    ...
    + apply CPrdE1 in Hx as [a [Ha [b [Hb Hx]]]].
      apply CPrdE1 in Hb as [β [Hβ [d [Hd Hb]]]].
      apply SingE in Hd. subst.
      assert (Hoβ: β ⋵ 𝐎𝐍). apply (ord_is_ords 𝜆)...
      apply UnionAx. exists (R (WOₒAdd α β⁺)). split.
      apply ReplAx. exists β⁺. split...
...
Proof with eauto.
  ...
  - rewrite A_WOₒMul, R_WOₒMul, R_WOₒMul...
    ext Hx. {
      ...
      (apply SepI; [
        apply binRelI; [eapply sub_mono_cprd'..|]|
        apply CPrdI
      ])...
      left. apply binRelE2 in H as [H1 [H2 H3]]. apply binRelI...
    } {
      apply SepE in Hx as [H1 H2].
      apply CPrdE1 in H2 as [a [Ha [b [Hb Hx]]]]; subst x.
      apply binRelE3 in H1 as []; apply binRelI...
      left. apply binRelI.
      - apply CPrdE0 in Ha as [_ Ha]... 
      - apply CPrdE0 in Hb as [_ Hb]...
      - apply binRelE3 in H...
    }
  - intros x Hx y Hy.
...
Proof with eauto.
  ...
  - apply binRelE1 in Hx as [a [Ha [b [Hb [Hx []]]]]]; subst;
    apply CPrdE1 in Ha as [s [Hs [t [Ht Ha]]]]; subst a;
    apply CPrdE1 in Hb as [u [Hu [v [Hc Hb]]]]; subst b; zfc_simple.
    + apply binRelE3 in H.
      apply UnionAx. exists (BR α v⁺). split.
      apply ReplAx. exists v⁺. split.
      apply sucord_in_limord... split...
      rewrite R_WOₒMul... apply ord_suc_is_ord. eapply ord_is_ords...
      apply binRelI; [apply CPrdI..|zfc_simple]... apply BUnionI1...
    ...
    + destruct H as [H Heq].
      ...
      apply sucord_in_limord... split...
      rewrite R_WOₒMul... apply ord_suc_is_ord. eapply ord_is_ords...
      apply binRelI; [apply CPrdI..|zfc_simple]...
