...
Require Export ZFC.Elements.EST5_4.
...
Proof with nauto.
  ...
  rewrite intMul_1_r, intMul_0_l in H; [|mr;nz..].
...
Proof with eauto.
  ...
  rewrite intAddInv_annih, intAdd_0_r, intAdd_0_r in H...
...
Proof with neauto.
  ...
  - exists 1. split... rewrite H, ω_embed_n, intMul_1_r...
  - exists 1. split... rewrite ω_embed_n, intMul_1_r...
    eapply intLt_trans...
  - assert (Hb' := Hb).
    apply pQuotE in Hb' as [m [Hm [n [Hn Heq]]]].
    apply intLt_iff_le_suc in Hpa as H1...
    rewrite intAdd_0_l in H1...
    assert (H2: Int 1 ⋅ b ≤ a ⋅ b)
      by (apply intMul_preserve_le; nauto). clear H1.
    rewrite intMul_1_l in H2...
    ...
    assert (H3: b <𝐳 ω_Embed[(m + 1)%ω]). {
      ...
      rewrite add_0_r... apply add_enlarge_lt...
      rewrite <- suc...
    }
    ...
    exists (m + 1)%ω. split...
    destruct H2. eapply intLt_trans... rewrite H...
Qed.
...
Proof with nauto.
  ...
  rewrite add_0_r, add_comm... apply neq_0_gt_0...
Qed.
...
Proof with neauto.
  ...
  - exists 1. split... rewrite H, Hemb, ratMul_1_r...
  - exists 1. split... rewrite Hemb, ratMul_1_r...
    eapply ratLt_trans...
  - apply pQuotE_ratPosDenom in Hr as [a [Ha [b [Hb [Hr Hpb]]]]].
    ...
    rewrite intEmbed_a, ratMul_a_b_c_d,
      intMul_1_r, Hcs, ω_embed_n, intMul_m_n_p_q,
    ...
    apply mul_preserve_lt... apply neq_0_gt_0...
    ...
    + rewrite <- (mul_1_r m) at 1 3...
      ...
      apply mul_preserve_le... apply neq_0_gt_0...
      apply lt_iff_suc_le...
    + apply mul_preserve_lt... apply neq_0_gt_0...
Qed.
...
Proof with neauto.
  ...
  - exists (-Int 1)%z. split...
    rewrite intEmbed_addInv, ratMul_addInv_r, ratMul_1_r, H...
    apply ratPos_neg...
  - exists (-Int 1)%z. split...
    rewrite intEmbed_addInv, ratMul_addInv_r, ratMul_1_r...
    eapply ratLt_trans. apply ratPos_neg... auto.
