...
Proof with eauto; try congruence.
  ...
  assert (Hbi: F: Dom ⟺ Ran). {
    ...
    - intros x Hx.
      ...
      + apply BUnionI1. apply CPrdI... eapply ap_ran...
      + apply BUnionI2. apply CPrdI... eapply ap_ran...
    ...
    - intros y Hy. apply BUnionE in Hy as [];
      ...
      + exists <f⁻¹[a], 0>. split. apply BUnionI1.
        apply CPrdI... eapply ap_ran... zfc_simple.
  ...
  - apply HbrS in Hp as H.
    apply CPrdE1 in H as [s [Hs [t [Ht H]]]]. subst.
  ...
  - apply CPrdE2 in Hxy as [H _];
    apply CPrdE2 in H as [_ H]; apply SingE in H...
  - apply HbrS' in Hp as H.
    apply CPrdE1 in H as [s [Hs [t [Ht H]]]].
...
Proof with neauto; try congruence.
  ...
  assert (Hbi: F: Dom ⟺ Ran). {
    ...
    - intros x1 H1 x2 H2 Heq.
      ...
      apply BUnionE in H2 as [H2|H2];
      apply CPrdE1 in H1 as [a [Ha [b [Hb H1]]]];
      apply CPrdE1 in H2 as [c [Hc [d [Hd H2]]]]; simpl in *;
      apply SingE in Hb; apply SingE in Hd; subst; zfc_simple;
  ...
  apply BUnionE in Hy as [Hy|Hy];
  apply CPrdE1 in Hx as [a [Ha [b [Hb Hx]]]];
  apply CPrdE1 in Hy as [c [Hc [d [Hd Hy]]]]; simpl in *;
  apply SingE in Hb; apply SingE in Hd; subst; zfc_simple;
  [(apply BUnionE in Hxy as [Hxy|Hxy]; [
    apply BUnionE in Hxy as [Hxy|Hxy];
    apply ReplAx in Hxy as [p [Hp H]]; 
  ...
  - apply binRelE3 in Hxy. apply BUnionI2. apply CPrdI; apply CPrdI...
...
Proof with neauto; try congruence.
  ...
  assert (Hbi: F: Dom ⟺ ω). {
    ...
    - intros y Hy. destruct (classic (y = 0)).
      + exists <0, 0>. split.
        * apply BUnionI1. apply CPrdI... apply BUnionI2...
        * zfc_simple. destruct (ixm (Embed 0 = 0))...
      + ω_destruct y. exfalso... exists <y, 1>. split.
        * apply BUnionI2. apply CPrdI...
        * zfc_simple. destruct (ixm (Embed 1 = 0))...
  }
  apply bijection_is_func in Hbi as HF. destruct HF as [HF _].
...
Proof with neauto; try congruence.
  ...
  assert (Hbi: F: Dom ⟺ ω⁺). {
    ...
    - intros y Hy. apply BUnionE in Hy as [].
      ...
      + apply SingE in H. subst. exists <0, 1>. split.
        * apply BUnionI2. apply CPrdI... apply BUnionI2...
        * zfc_simple. destruct (ixm (Embed 1 = 0))...
  }
  apply bijection_is_func in Hbi as HF. destruct HF as [HF _].
  exists F. split; simpl...
  ...
  - apply binRelE3 in Hxy. apply BUnionI1. apply BUnionI1.
    apply ReplAx. exists <a, c>. split; zfc_simple. apply binRelI...
  - apply binRelE3 in Hxy. apply BUnionI2. apply CPrdI; apply CPrdI...
  - apply binRelE3 in Hxy. exfalso. eapply ord_not_lt_gt; revgoals...
  ...
  assert (Hbi: F: ω × {0,} ∪ ω × {1,} ⟺ ℤ). {
    ...
    - intros y Hy.
      ...
      + apply nat_subtr in H as [d [Hd Hsubtr]]...
        exists <d, 0>. split. apply BUnionI1. apply CPrdI...
        zfc_simple. destruct (ixm (Embed 0 = 0))...
