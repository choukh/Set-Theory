...
Require Export ZFC.Elements.EST7_4.
...
Proof with eauto; try congruence.
  ...
  assert (Hα: α ⋵ 𝐎𝐍). {
    ...
    - apply Hstar in Hβ as [_ [w [Hw [S [Heqβ [HA HR]]]]]].
      ...
      + apply SepI; zfc_simple...
        apply SepE1 in Hw. apply CPrdE0 in Hw as [H1 H2].
    ...
    - apply Hords in Hβ as Hoβ.
      ...
      apply (dominate_trans γ β)... apply dominate_sub.
  ...
  - exists α. repeat split...
    + intros Hdom. eapply ord_irrefl...
      ...
      * apply SepI; zfc_simple... apply CPrdI; apply PowerAx...
    ...
    + intros β Hβ Hneg. apply ord_le_iff_not_gt...
...
Proof with eauto; try congruence.
  ...
  assert (Hind1: ∀ β γ ∈ α, F[β] ≠ e → F[γ] ≠ e →
    ...
    apply restrI... eapply func_point...
  }
...
Proof with eauto.
  ...
  assert (Hstar: ∀ξ ⋵ 𝐎𝐍, ξ ≈ A → ξ ∈ α). {
    ...
    exfalso. apply ord_le_iff_not_gt in H...
