...
Proof with eauto; try apply mul_ran; repeat apply ω_inductive; auto.
  ...
  - set {n ∊ ω | λ n, even n ∨ odd n} as N.
    ω_induction N Hn.
    + left. split... exists 0. split... rewrite mul_0_r...
    + destruct IH.
      * right. split... destruct H as [_ [k [Hk Heq]]].
        exists k. split... rewrite Heq, suc_eq_add_1...
      * left. split. apply ω_inductive...
        destruct H as [_ [k [Hk Heq]]].
        exists k⁺. split. apply ω_inductive...
        rewrite Heq, (Pred 1), add_m_n, add_0_r...
        rewrite suc_eq_add_1, suc_eq_add_1, mul_m_n...
        rewrite (add_comm 2)...
        rewrite (add_assoc (2⋅k))...
        cut (1 + 1 = 2); try congruence...
        rewrite Pred, add_m_n, add_0_r... apply mul_ran...
  - set {n ∊ ω | λ n, ¬ (even n ∧ odd n)} as N.
    ω_induction N Hn; intros [[_ [k [Hk Hkeq]]] [_ [p [Hp Hpeq]]]].
    + rewrite <- suc_eq_add_1 in Hpeq...
      exfalso. eapply S_neq_0. rewrite Hpeq...
    + apply IH. split.
      * split... exists p. split...
        rewrite <- suc_eq_add_1 in Hpeq... apply S_injection in Hpeq...
      * split... ω_destruct k; subst k.
        rewrite mul_0_r in Hkeq... exfalso. eapply S_neq_0...
        exists n'. split...
...
Proof with eauto.
  ...
  - exists 0. split... exists 0. split... split.
    rewrite mul_0_r, add_0_r... apply ineq_nq_0_gt_0...
  - apply (IH d Hd) in Hnq0 as [q [Hq [r [Hr [Heq Hrd]]]]]...
    ...
    + subst d. exists q⁺. split. apply ω_inductive...
      ...
      rewrite add_0_r, mul_m_n, add_comm, add_m_n; try apply mul_ran...
...
Proof with eauto.
  ...
  - rewrite add_0_l. apply empty_in_s... apply ω_inductive...
...
Proof with eauto.
  ...
  - ω_destruct a; subst a.
    + exists 0. split. apply S_has_0... rewrite add_0_r...
    + exfalso. apply Hna. apply S_has_0...
  - destruct (classic (m⁺ = a)).
    exists 0. split. apply empty_in_s... rewrite add_0_r...
...
Proof with eauto.
  ...
  - assert (Hxw: x ∈ ω). {
    ...
    apply S_has_0... rewrite mul_0_r, add_0_l...
