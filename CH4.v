...
Proof with eauto; try congruence.
  ...
  - ω_destruct l... exfalso. eapply Hnq0... subst l.
    ...
    eapply func_injective; eauto; rewrite Hdf; apply Hrh;
      eapply ranI; apply func_correct...
Qed.
  ...
  - set {n ∊ ω | λ n, ¬ (even n ∧ odd n)} as N.
    ...
    + apply IH. split.
      * split... exists p. split...
        rewrite <- suc_eq_add_1 in Hpeq... apply suc_injective in Hpeq...
...
Proof with neauto.
  ...
  - exists 0. split... exists 0. split... split.
    rewrite mul_0_r, add_0_r... apply nq_0_gt_0...
  - apply (IH d Hd) in Hnq0 as [q [Hq [r [Hr [Heq Hrd]]]]]...
    apply lt_both_side_suc in Hrd...
...
Proof with eauto.
  ...
  - rewrite add_m_n'... apply (lt_both_side_suc m)...
...
Proof with try apply ω_inductive; auto.
  ...
  apply lt_both_side_add... apply add_ran... apply add_ran...
  rewrite add_comm... apply lt_both_side_add...
  apply lt_both_side_mul... apply suc_neq_0.
Qed.
...
Proof with eauto.
  ...
  - destruct (classic (m⁺ = a)).
    ...
    apply lt_both_side_suc in Hnab; try apply add_ran...
...
Proof with eauto; try congruence.
  ...
  - (* single_rooted h *)
    ...
    + rewrite <- Hfd in Hxm1, Hxm2.
      eapply func_injective; revgoals... split...
  ...
  - apply ExtAx. intros y. split; intros Hy.
    ...
    + rewrite <- Hgr in H. apply ranE in H as [b Hp].
      ...
      * apply CProdI... rewrite add_comm...
        apply lt_both_side_add; revgoals...
...
Proof with eauto.
  ...
  - assert (Hxw: x ∈ ω). {
    ...
    apply lt_both_side_suc in Hj; try apply ω_inductive...
Qed.
...
Proof with auto.
  ...
  - subst. rewrite add_comm, (add_comm (k⋅m))...
    apply lt_both_side_add... apply mul_ran...
...
intros * [Hm [f [[Hff Hfs] [Hfd Hfr]]]]
  ...
  - (* single_rooted h *)
    ...
    apply func_injective in Heqfi; revgoals... split...
    apply func_injective in Heqfj; revgoals... split...
  - apply ExtAx. intros x. split; intros Hx.
    (* dom h ⊆ m ⋅ n *)
    apply domE in Hx as [y Hp]. apply SepE in Hp as [Hp _].
    apply CProdE1 in Hp as []; zfcrewrite.
