...
Proof with eauto; try apply mul_ran; repeat apply ω_inductive; auto.
  ...
  - set {n ∊ ω | λ n, even n ∨ odd n} as N.
    ω_induction N Hn.
    + left. split... exists 0. split... rewrite mul_m_0...
    + destruct IH.
      ...
      * left. split. apply ω_inductive...
        ...
        rewrite Heq, (Pred 1), add_m_n, add_m_0...
        rewrite add_n_1, add_n_1, mul_m_n...
        rewrite (add_comm 2)...
        rewrite <- (add_assoc (2⋅k))...
        cut (1 + 1 = 2); try congruence...
        rewrite Pred, add_m_n, add_m_0... apply mul_ran...
  - set {n ∊ ω | λ n, ¬ (even n ∧ odd n)} as N.
    ...
    + apply IH. split.
      ...
      * split... ω_destruct k; subst k.
        rewrite mul_m_0 in Hkeq... exfalso. eapply S_neq_0...
        exists n'. split...
...
Proof with eauto.
  ...
  - exists 0. split... exists 0. split... split.
    rewrite mul_m_0, add_m_0... apply ineq_nq_0_gt_0...
  - apply (IH d Hd) in Hnq0 as [q [Hq [r [Hr [Heq Hrd]]]]]...
    ...
    + subst d. exists q⁺. split. apply ω_inductive...
      ...
      rewrite add_m_0, mul_m_n, add_comm, add_m_n; try apply mul_ran...
...
Proof with try apply ω_inductive; auto.
  ...
  apply ineq_both_side_mul... apply S_neq_0.
Qed.
...
Proof with eauto; try congruence.
  ...
  - ω_destruct j2; subst j2... exfalso.
    rewrite mul_m_0, add_0_n in Heq... rewrite Heq in Hlt1.
    apply ineq_lt_add_shrink in Hlt1; try apply mul_ran...
    eapply not_leq_gt; revgoals. apply Hlt1.
    apply ineq_leq_mul_enlarge...
    apply mul_ran... apply Hn.
  - ω_destruct j2; subst j2.
    + exfalso. rewrite mul_m_0, add_0_n in Heq...
      rewrite <- Heq in Hlt2.
...
Proof with eauto.
  ...
  - rewrite mul_m_0 in Hx... exfalso0.
  - assert (Hxw: x ∈ ω). {
    ...
    apply S_has_0... rewrite mul_m_0, add_0_n...
...
Proof with auto.
  ...
  - subst. rewrite add_comm, (add_comm (k⋅m))...
    apply ineq_both_side_add... apply mul_ran...
...
Proof with eauto; try congruence.
  ...
  assert (Hhf: is_function h). {
    ...
    eapply add_elim; revgoals... apply mul_ran...
  }
  exists h. split; [split; auto | split; [auto|split]].
  - (* single_rooted h *)
    intros y Hy. split. apply ranE in Hy...
