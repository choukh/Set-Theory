...
Proof with try apply ω_inductive; auto.
  ...
  apply ineq_both_side_mul... apply suc_neq_0.
Qed.
...
Proof with eauto.
  ...
  - destruct (classic (m⁺ = a)).
    exists 0. split. apply suc_has_0... rewrite add_0_r...
    apply ωLt_connected in H as []; try apply ω_inductive...
    exfalso. apply Hna...
    assert (Hma: m ∉ a). {
    ...
    apply ωLt_connected in H0 as []; revgoals... exfalso.
