...
Proof with try apply ω_inductive; nauto.
  ...
  repeat rewrite mul_ident, mul_0_r...
...
Proof with nauto.
  ...
  rewrite intMul_m_n_p_q...
  rewrite mul_0_l, mul_0_r, mul_0_r, add_ident, add_ident...
...
Proof with nauto.
  ...
  rewrite add_ident, add_ident' in Heq; auto; amr...
  assert (Hmn: m ≠ n). {
...
Proof with nauto.
  ...
  apply pQuotE in Ha as [m [Hm [n [Hn Ha]]]]. subst a.
  unfold Int. rewrite intMul_m_n_p_q...
  rewrite mul_ident, mul_ident, mul_0_r, mul_0_r, add_ident, add_ident'...
Qed.
...
Proof with nauto.
  ...
  rewrite mul_ident, mul_ident, add_ident', add_ident'...
Qed.
...
Proof with neauto.
  ...
  apply pQuotE in Hb as [p [Hp [q [Hq Hb]]]]. subst b.
  apply pQuotE in Hc as [r [Hr [s [Hs Hc]]]]. subst c.
  apply intLt in Hpc... rewrite add_ident, add_ident' in Hpc...
...
Proof with nauto.
  ...
  rewrite add_ident, add_comm, (embed_proj_id d)...
Qed.
...
Proof with nauto.
  ...
  rewrite intAdd_m_n_p_q, add_ident...
Qed.
...
Proof with nauto.
  ...
  rewrite intMul_m_n_p_q, mul_0_r, mul_0_r,
    mul_0_l, add_ident, add_ident... apply mul_ran...
Qed.
...
Proof with auto.
  ...
  rewrite add_ident, add_ident... reflexivity.
Qed.
...
Proof with nauto.
  intros m Hm n Hn.
  repeat rewrite ω_embed_n...
  rewrite intAddInv, intAdd_m_n_p_q, add_ident, add_ident'...
Qed.
