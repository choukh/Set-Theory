...
Proof with eauto; try congruence.
  ...
  apply (lo_connected R A) in Hnq as []; revgoals... apply Hd...
...
Proof with eauto; try congruence.
  ...
  - assert (HNᵣ: (Min Lt)[Nᵣ] ∈ Nᵣ). eapply (right_nats A R a)...
    ...
    apply (lo_connected R A) in Hnq as []; revgoals... eapply ap_ran...
    ...
    unfold Add; [
      ...
      - split; intros Hlt.
        ...
        + set (RightNats x₀ R S b f) as N.
          ...
          apply Hd... exfalso. eapply (relLt_irrefl x₁ R)...
          eapply relLt_le_tranr...
          * apply Hop... eapply relLt_tranr...
          * apply Hle...
      - split; intros Hlt.
        + set (LeftNats x₀ R S b f) as N.
          ...
          * subst...
        + apply (lo_connected R A) in Hnq as [H10|H01]; revgoals...
          apply Hd... exfalso. eapply EmptyNI in HR...
          exists x₁. apply SepI...
      - split; intros Hlt.
      ...
      - split; intros Hlt.
        ...
        + apply (lo_connected R A) in Hnq as [H20|H02]; revgoals...
          apply Hd... exfalso. eapply EmptyNI in HL...
          exists x₂. apply SepI...
      - split; intros Hlt.
...
Proof with neauto; try congruence.
  ...
  assert (Hg: g: ps ⇒ ps). {
    ...
    - destruct (ixm (odd n)). {
      ...
      + apply CProdI... apply Hfsᶠ... 
      + zfc_simple. simpl. destruct (ixm (odd n⁺))... split.
        * rewrite odd_halve_suc, even_halve_suc... apply Hindᶠ...
    ...
    - destruct (ixm (odd n)) as [Ho|]; revgoals. {
      ...
      + apply CProdI... apply Hfsᵇ...
      + zfc_simple. simpl. destruct (ixm (odd n⁺))... split.
        * eapply sub_tran...
        * rewrite odd_halve_suc... apply Hindᵇ...
  }
...
Proof with neauto; try congruence.
  ...
  apply nat_connected in H as []...
  - assert (Hxm: x ∈ dom G[m]). eapply Hsub2...
    rewrite Hin2... split; intros Hlt; apply Hop2...
  - assert (Hyn: y ∈ dom G[n]). eapply Hsub1...
